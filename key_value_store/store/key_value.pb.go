...
type Stat struct {
	...
	GetCount             int32    `protobuf:"varint,3,opt,name=get_count,json=getCount,proto3" json:"get_count,omitempty"`
	GetPrefixCount       int32    `protobuf:"varint,4,opt,name=get_prefix_count,json=getPrefixCount,proto3" json:"get_prefix_count,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *Stat) GetStartTime() string {
	if m != nil {
		return m.StartTime
	}
	return ""
...
func (m *Stat) GetGetPrefixCount() int32 {
	if m != nil {
		return m.GetPrefixCount
	}
	return 0
}
...
func (*StatRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_40f3a6d8264e424e, []int{5}
}
...
var fileDescriptor_40f3a6d8264e424e = []byte{
	...
	,
}
...
type KeyValueStoreClient interface {
	...
	GetStats(ctx context.Context, in *StatRequest, opts ...grpc.CallOption) (*Stat, error)
}
...
func (c *keyValueStoreClient) GetStats(ctx context.Context, in *StatRequest, opts ...grpc.CallOption) (*Stat, error) {
	out := new(Stat)
	err := c.cc.Invoke(ctx, "/KeyValueStore/GetStats", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type KeyValueStoreServer interface {
	...
	GetStats(context.Context, *StatRequest) (*Stat, error)
}
...
func (*UnimplementedKeyValueStoreServer) GetStats(ctx context.Context, req *StatRequest) (*Stat, error) {
...
func _KeyValueStore_GetStats_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(StatRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(KeyValueStoreServer).GetStats(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/KeyValueStore/GetStats",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(KeyValueStoreServer).GetStats(ctx, req.(*StatRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _KeyValueStore_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetStats",
			Handler:    _KeyValueStore_GetStats_Handler,
		},
	},
